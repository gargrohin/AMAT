...
experiment = comet_ml.Experiment(project_name="stackedmnist_dcgan_0")

exp_parameters = {
    "data": "stacked_64x64_total_600k",
    "model": "64xDConv dis",
...
for epoch in range(1, n_epoch+1):
    ...
    path_to_save = "../models/stacked_mnist_dcgan_1/dc64_ganns_"
    if epoch%1 == 0:
    ...
    with torch.no_grad():
        if epoch == 1:
            vutils.save_image(x[:64].cpu(), output ,normalize=True)
            experiment.log_image(output, name = "real")
