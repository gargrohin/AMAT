...
# optimizer
lr = 0.0001 * 10
G_optimizer = optim.SGD(G.parameters(), lr = lr, momentum = 0.0)
D_optimizer = optim.SGD(D.parameters(), lr = lr, momentum = 0.0)
...
experiment = comet_ml.Experiment(project_name="mnist_baselines_gan")

exp_parameters = {
    "data": "mnist_28x28",
    "model": "GAN_ 4fc_dropout_dis",
    "opt_gen": "SGD_lr_0.001, momentum = 0",
    "opt_dis": "SGD_lr_0.001, momentum = 0",
    "z_dim": 100,
