...
experiment = comet_ml.Experiment(project_name="stacked_multi_0")
...
for epoch in range(1, n_epoch+1):
    ...
    path_to_save = "../models/stacked_multi_4/dc64_ganns_"
    if epoch%1 == 0:
