  ...
  while(True):
    ...
    for _, imgs in enumerate(dataloader):
      ...
      if it%n_critic == 0:
        ...
        critic_fake = critic_fakes/n_dis
      ...
      if it%1000 == 0:
        ...
        for i in range(n_dis):
          ...
          Z = multi_dis[i](torch.Tensor(add_nonlinearity(Dinput)).cuda())
...
experiment = comet_ml.Experiment(project_name="ring_multiD_nonlinear_GAN")

exp_parameters = {
    "data": "8gaussians_nonlinear_f2",
    "model": "GAN_og_noBN",
...
train(gen, multi_dis, gen_optim, multi_dis_optim, args, experiment)
