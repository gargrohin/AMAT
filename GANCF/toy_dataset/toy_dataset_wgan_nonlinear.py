...
experiment = comet_ml.Experiment(project_name="ring_nonlinear_WGAN")

exp_parameters = {
    "data": "8gaussians_nonlinear_f2",
    "model": "WGAN_7layers_noBN",
...
path_to_save = '../models/wgan_nonlinear/wgan_nonlinear2_7layer_'
torch.save(dis.state_dict(), path_to_save + "_D.pth")
torch.save(gen.state_dict(), path_to_save + "_G.pth")
