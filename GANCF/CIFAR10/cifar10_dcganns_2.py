...
# optimizer
lr = 0.0001
G_optimizer = optim.Adam(G.parameters(), lr = lr*10, betas = (0.5, 0.999))
...
experiment = comet_ml.Experiment(project_name="cifar10_dcgan_2")

exp_parameters = {
    "data": "cifar10_32x32",
    "model": "32xDConv",
    "opt_gen": "Adam_lr_0.001, (0,5,0.999)",
    ...
    "dis_landscape": 0,
    "try": 1,
    "model_save": "cifar10_dcgan32_lr10"
}
...
for epoch in range(1, n_epoch+1):
    ...
    path_to_save = "../models/cifar10_dcgan_32_lr10/dc64_ganns_"
    if epoch%10 == 0:
