...
experiment = comet_ml.Experiment(project_name="cifar10_unrolled_dcgan")

exp_parameters = {
    "data": "cifar10_64x64",
    "model": "64xDConv",
    "model_save": "cifar10_unrolled_10_0.2_0.2_stdmean",
...
for epoch in range(1, n_epoch+1):
    ...
    path_to_save = "../models/cifar10_unrolled_10_0.2_0.2_stdmean/dc64_ganns_"
    if epoch%10 == 0:
